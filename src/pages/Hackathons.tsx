        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div className="p-6 md:p-8 border border-white/10 bg-white/[0.02]">
              ...
              <div className="text-xl md:text-2xl font-brutal uppercase tracking-tighter">
                {hackathons[0].date}
              </div>
            </div>
            <div className="p-6 md:p-8 border border-white/10 bg-white/[0.02]">
      ...
      <section className="px-6 mb-24 md:mb-48 py-24 md:py-32 bg-white/[0.02] border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-5xl md:text-8xl font-brutal tracking-tighter uppercase">
              Operation <span className="text-primary">Timeline</span>
            </h2>
          </div>
          <div className="space-y-8 md:space-y-12">
            {[
              ...
              <div
                key={i}
                className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-12 border-b border-white/5 pb-8 group hover:border-primary transition-colors"
              >
                <div className="text-xl md:text-2xl font-mono text-slate-500 group-hover:text-primary transition-colors w-32 shrink-0">
                  {item.time}
                </div>
                <div className="flex-1">
                  <h3 className="text-2xl md:text-3xl font-brutal uppercase tracking-tighter">
                    {item.event}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 opacity-50 grayscale">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="h-12 bg-white/10 rounded flex items-center justify-center font-brutal text-xl"
              >
                SPONSOR_{i + 1}
              </div>
            ))}
