      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          <div className="space-y-10">
            <div>
              <h3 className="text-5xl md:text-7xl font-brutal uppercase tracking-tighter mb-4">
                Abhishek
              </h3>
              <p className="text-primary font-mono text-lg tracking-widest uppercase">
                Full Stack Developer / MERN Developer
              </p>
            </div>

            <p className="text-xl md:text-2xl text-slate-400 leading-relaxed font-medium max-w-2xl">
              Hi, I'm Abhishek — a passionate full stack developer focused on building scalable,
              real-world applications. I specialize in MERN stack, system design, and creating
              impactful developer communities like Apex Circle.
            </p>

            <div className="flex flex-wrap gap-4">
              {['React', 'Node.js', 'MongoDB', 'Express', 'TypeScript', 'Next.js', 'Tailwind'].map(
                (tech) => (
                  <span
                    key={tech}
                    className="px-6 py-2 border border-white/10 bg-white/5 text-[10px] font-black uppercase tracking-widest hover:border-primary hover:text-primary transition-all cursor-default hover:scale-105 transform"
                  >
                    {tech}
                  </span>
                ),
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8 pt-8">
              <div className="flex items-center gap-6">
                <a
                  ...
                  className="p-4 border border-white/10 hover:border-primary hover:text-primary transition-all group hover:bg-primary/5"
                >
