      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 md:mb-32">
          ...
          <p className="text-xl md:text-2xl text-slate-400 max-w-3xl leading-relaxed">
            Join the elite collective of architects and visionaries building the next generation of
        ...
        <div className="space-y-6 md:space-y-8">
          {jobs.map((job) => (
            <div
              key={job.id}
              className="job-card group p-8 md:p-12 border border-white/10 bg-white/[0.02] hover:border-primary transition-all duration-500 flex flex-col md:flex-row justify-between items-start md:items-center gap-8"
            >
              <div className="flex-1 w-full">
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
                  <h3 className="text-3xl md:text-4xl font-brutal tracking-tighter uppercase group-hover:text-primary transition-colors">
                    {job.title}
                  </h3>
                  <span className="w-fit text-[10px] font-black px-3 py-1 border border-white/20 text-slate-500 group-hover:border-primary group-hover:text-primary transition-colors">
                    {job.type}
                  </span>
                </div>
                <p className="text-slate-500 max-w-xl leading-relaxed mb-6 text-sm md:text-base">
                  {job.desc}
                </p>
        ...
        <div className="mt-24 md:mt-48 py-24 md:py-32 border-t border-white/5 text-center">
          ...
          <h2 className="text-3xl md:text-6xl font-brutal tracking-tighter uppercase mb-8">
            Don't see your <span className="text-slate-500">Role?</span>
          </h2>
          <p className="text-lg text-slate-500 leading-relaxed mb-12 max-w-2xl mx-auto">
            We're always looking for exceptional talent. If you're an elite architect or visionary,
            send us your protocol proposal.
          </p>
