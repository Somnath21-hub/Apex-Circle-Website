      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-24 md:mb-48 py-24 md:py-32 border-y border-white/5 bg-white/[0.01]">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
            {[
              ...
              <div key={i}>
                <div className="text-4xl sm:text-5xl md:text-8xl font-brutal tracking-tighter mb-4 text-secondary">{stat.value}</div>
        ...
        <section className="mb-24 md:mb-48">
          <div className="text-center mb-16 md:mb-24">
            <span className="text-secondary font-mono text-sm mb-4 block tracking-widest uppercase">// Future_Protocol</span>
            <h2 className="text-3xl md:text-6xl font-brutal tracking-tighter uppercase">System <span className="text-slate-500">Roadmap</span></h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              { phase: "Phase 01", title: "Core Hardening", desc: "Optimizing protocol performance and security audits." },
              { phase: "Phase 02", title: "Ecosystem Expansion", desc: "Integrating multi-chain support and cross-protocol bridges." },
              { phase: "Phase 03", title: "Mass Adoption", desc: "Launching consumer-facing applications and global marketing." },
            ].map((step, i) => (
              <div key={i} className="p-8 md:p-12 border border-white/10 bg-white/[0.02] hover:border-secondary transition-colors">
                <div className="text-secondary font-mono text-lg md:text-xl mb-4">[{step.phase}]</div>
                <h4 className="text-2xl md:text-3xl font-brutal uppercase tracking-tighter mb-4">{step.title}</h4>
