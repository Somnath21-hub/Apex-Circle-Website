...
const posts: BlogPost[] = [
  {
    ...
    excerpt:
      'Exploring the next generation of self-sovereign identity protocols and their impact on digital sovereignty.',
    author: 'Alex Rivera',
    date: 'March 28, 2026',
    category: 'Protocol',
  ...
  },
  {
    ...
    excerpt:
      'A technical deep-dive into the latest advancements in Zero-Knowledge rollups and optimistic scaling.',
    author: 'Sarah Chen',
    date: 'March 25, 2026',
  ...
  },
  {
    ...
    excerpt:
      'How decentralized governance models are reshaping the way we collaborate and build together.',
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 md:mb-32">
          ...
          <p className="text-xl md:text-2xl text-slate-400 max-w-3xl leading-relaxed">
            Technical deep-dives, community updates, and research from the core architects of Apex
            Circle.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {posts.map((post) => (
            <div
              key={post.id}
              className="blog-card group bg-white/[0.02] border border-white/10 hover:border-primary transition-all duration-500 overflow-hidden"
            >
